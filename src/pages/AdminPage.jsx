...
import CustomerActions, { CustomerProfileButton } from "../components/admin/CustomerActions";
...
function DataTable({ module, rows, filtered, currentUser, onEdit, onDelete, onReload, setError, setNotice }) {
  ...
  const actions = (row) => {
    ...
    if (module === "customers") return <CustomerActions customer={row} role={currentUser.role} onReload={onReload} setError={setError} setNotice={setNotice} />;
