...
export default function AdminLoginPage() {
  ...
  if(user&&ADMIN_ROLES.has(user.role))return <Navigate replace to="/admin/dashboard"/>;
  if(user)return <div className="admin-gate"><ShoppingBasket/><h1>Access denied</h1><p>You do not have administrator permissions.</p><button type="button" onClick={signOutUser}>Sign out</button></div>;
